...
public class TravelDetailActivity extends BaseActivity implements
    ...
    public ImageButton commentBtn, shareBtn, collectBtn, likeBtn;
	...
	private ResponseTravelDetail responseDetail = new ResponseTravelDetail();
	...
	private void initView() {
		...
		refresh = (Button) findViewById(R.id.error_btn);
		errorTxt = (TextView) findViewById(R.id.error_txt);
	...
	protected void doBackGround() throws Exception {
		...
		responseDetail = WebserviceUtils.getTravelDetail(busiId, custId,
				modId);
	}
	...
	protected void doForeGround() throws Exception {
		...
		//mWebView.loadDataWithBaseURL(CodeConstants.URL_PREFIX,htmlContent, "text/html; charset=UTF-8", null,"");
	...
	class MyWebviewClient extends WebChromeClient {
		...
		public void onProgressChanged(WebView view, int newProgress) {
			if (newProgress == 100) {
				...
				// 判断有无网络
				if (!Utils.isNetworkAvailable(TravelDetailActivity.this)) {
	...
	// 操作点赞按钮前先验证是否登录
		private void likeFunction() {
			int type = TYPE_LIKE;
			LogUtil.i(TAG, "application.isLogin()=" + application.isLogin());
			if (application.isLogin()) {
...
//	private void share() {
//		//shareMsg("TravelDetailActivity", "分享", "我是分享文本", "http://f1.sharesdk.cn/imgs/2014/02/26/owWpLZo_638x960.jpg","http://www.crystalnet.com.cn/");
