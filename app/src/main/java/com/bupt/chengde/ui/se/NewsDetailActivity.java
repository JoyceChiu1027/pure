...
public class NewsDetailActivity extends BaseActivity
	...
	private ResponseSerNewsDtl responseDetail;
	// 状态变量
...
//	SharePopupWindow popupWindow = null;
	...
	protected void doForeGround() throws Exception {
		if (responseDetail != null) {
			...
			if (!URLUtil.isValidUrl(responseDetail.getUrl())) {
				url =CodeConstants.HTML_URL_PREFIX+ responseDetail.getUrl();
			}else{
				url =responseDetail.getUrl();
			}*/
