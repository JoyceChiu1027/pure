...
public abstract class LazyFragment extends BaseFragment {
    ...
    protected final void onCreateView(Bundle savedInstanceState) {
        LogUtil.d(TAG, "onCreateView() : " + "getUserVisibleHint():" + getUserVisibleHint());
    ...
    public final void onStart() {
        LogUtil.d("TAG", "onStart() : " + "getUserVisibleHint():" + getUserVisibleHint());
        super.onStart();
    ...
    public final void onStop() {
        super.onStop();
        LogUtil.d("TAG", "onStop() called: " + "getUserVisibleHint():" + getUserVisibleHint());
        if (isInit && isStart && getUserVisibleHint()) {
            isStart = false;
            onFragmentStopLazy();
        }
    ...
    protected void onCreateViewLazy(Bundle savedInstanceState) {
        LogUtil.d(TAG, "onCreateViewLazy() called with: " + "savedInstanceState = [" + savedInstanceState + "]");
    }
    ...
    public  void onResume() {
        LogUtil.d(TAG, "onResume() : " + "getUserVisibleHint():" + getUserVisibleHint());
        super.onResume();
        if (isInit) {
            onResumeLazy();
        }
    ...
    @Override
    public  void onPause() {
        LogUtil.d(TAG, "onPause() : " + "getUserVisibleHint():" + getUserVisibleHint());
        super.onPause();
        if (isInit) {
            onPauseLazy();
        }
    ...
    public  void onDestroyView() {
        LogUtil.d(TAG, "onDestroyView() : " + "getUserVisibleHint():" + getUserVisibleHint());
        super.onDestroyView();
        if (isInit) {
            onDestroyViewLazy();
        }
