...
import com.bupt.chengde.widget.XListView.OnXScrollListener;
...
public class XGridView  extends GridViewWithHeaderAndFooter implements OnScrollListener {
	...
	// 触发刷新和加载更多的接口。
	private IXGridViewListener mGridViewListener;
	...
	public void setXListViewListener(IXGridViewListener l) {
		mGridViewListener = l;
	}
