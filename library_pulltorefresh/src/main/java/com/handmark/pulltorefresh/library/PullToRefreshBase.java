...
//		ImageView headiconicon = (ImageView)mHeaderLayout.findViewById(R.id.iconiconicon);
//		headiconicon.setVisibility(View.VISIBLE);
		
//		ImageView footericonicon = (ImageView)mFooterLayout.findViewById(R.id.iconiconicon);
//		footericonicon.setVisibility(View.GONE);
		/**
		 * Styleables from XML
		 */
